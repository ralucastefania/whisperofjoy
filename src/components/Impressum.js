...
export default function Impressum() {
  return (
    <div>
      ...
      <p className="impressum-page">
        Angaben gemäß § 5 TMG Raluca-Stefania Bochis Sandpfadweg 5/8 69168
        Wiesloch Vertreten durch: Raluca-Stefania Bochis Kontakt:
        Telefon:+4917621042785 E-Mail: office@whisperofjoy.com Umsatzsteuer-ID:
        Umsatzsteuer-Identifikationsnummer gemäß §27a Umsatzsteuergesetz:
        37042581790 Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV:
        Raluca-Stefania Bochis Sandpfadweg 5/8 69168 Wiesloch
        ...
        Zusendung von Werbeinformationen, etwa durch Spam-Mails, vor. Google
        Analytics Diese Website benutzt Google Analytics, einen Webanalysedienst
        der Google Inc. (''Google''). Google Analytics verwendet sog.
        ''Cookies'', Textdateien, die auf Ihrem Computer gespeichert werden und
        die eine Analyse der Benutzung der Website durch Sie ermöglicht. Die
        ...
        Zweck einverstanden. Google AdSense Diese Website benutzt Google
        Adsense, einen Webanzeigendienst der Google Inc., USA (''Google'').
        ...
        Website durch Sie ermöglicht. Google Adsense verwendet auch sog. ''Web
        Beacons'' (kleine unsichtbare Grafiken) zur Sammlung von Informationen.
        ...
        Weise und zu dem zuvor benannten Zweck einverstanden. Impressum vom{" "}
        <a
